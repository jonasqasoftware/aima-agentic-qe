...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; } body { margin:0; background:radial-gradient(circle at top right,#183257,transparent 36%),var(--bg); color:var(--ink); font:16px/1.5 Inter,ui-sans-serif,system-ui,sans-serif; }
    ...
    .REMOTE_EVIDENCE { color:#b8c7ff; background:#242c64; } .EXECUTED_EVIDENCE { color:#ffb7ea; background:#54204b; } .TEST_RESULTS_EVIDENCE { color:#ffcf87; background:#59380e; } footer { margin-top:46px; color:var(--muted); font-size:.875rem; } @media (max-width:700px) { main { padding-top:32px; } .summary,.two-columns { grid-template-columns:1fr; } }
  </style>
</head>
<body><main>
