...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; } body { margin:0; background:radial-gradient(circle at top right,#183257,transparent 36%),var(--bg); color:var(--ink); font:16px/1.5 Inter,ui-sans-serif,system-ui,sans-serif; }
    ...
    .two-columns { display:grid; grid-template-columns:1fr 1fr; gap:16px; } ul { padding-left:20px; color:var(--muted); } li+li { margin-top:8px; } .table-wrap { overflow:auto; border:1px solid var(--line); border-radius:12px; } table { width:100%; border-collapse:collapse; min-width:700px; } th,td { padding:12px 14px; text-align:left; border-bottom:1px solid var(--line); vertical-align:top; } th { color:var(--muted); font-size:.75rem; text-transform:uppercase; letter-spacing:.08em; } .kind { font:600 11px ui-monospace,SFMono-Regular,monospace; padding:4px 6px; border-radius:99px; } .FACT { color:var(--blue); background:#14345d; } .DECLARED_EVIDENCE { color:#d5b7ff; background:#35245a; } .INFERENCE { color:var(--green); background:#123d32; } .UNKNOWN { color:var(--yellow); background:#493a10; }
